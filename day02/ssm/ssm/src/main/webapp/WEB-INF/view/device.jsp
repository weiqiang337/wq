...
<body class="gray-bg">
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_ss_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveadd.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>状态：</td>
								<td colspan="4">
									<select class="form-control" name="status" id ="status1" aria-required="true" required>
										<option value="">---请选择---</option>
										<c:forEach items="${list }" var="s">
										 	<option value="${s}">${s}</option>
										</c:forEach>
	...
	<div class="modal fade" id="modal_in_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_in" method="post" action="inDevice.htm">
						<input type="hidden" name="id" id="hidden_txt_userid" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
							<td>请选择文件：<input type="file" name="file"></td>
							</tr>
						</table>
						<div class="modal-footer">
	...
	<div class="modal fade" id="modal_zz_edit" role="dialog" aria-labelledby="modal_zz_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$('#modal_ss_edit').modal({backdrop: 'static', keyboard: false});
				$('#modal_ss_edit').modal('show');
	        });
	    		...
	    		$.ajax({
	    		    ...
	    		    success:function(res){
		    	        ...
		    	        myChart.setOption(option);
				    		$('#modal_zz_edit').modal({backdrop: 'static', keyboard: false});
							$('#modal_zz_edit').modal('show');
	    	    	    }
	    	    	}
	...
	function initEditUser(getSelection){
		...
		$('#status1').val(getSelection.status);
