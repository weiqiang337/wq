        ...
        <div class="row">
			 ...
			 <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input readonly="readonly" placeholder="输入时间" id="txt_search_start" name="entrytime" class="laydate-icon form-control layer-date"/>
				</div>
			  </div>
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>入校时间：</td>
								<td>
									<input readonly="readonly" placeholder="开始时间" id="entrytime" name="entrytime" class="laydate-icon form-control layer-date"/>
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>代课老师：</td>
								<td>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            grade: $("#grade").val(),
	            entrytime: $("#txt_search_start").val(),
