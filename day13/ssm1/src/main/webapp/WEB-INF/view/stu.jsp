...
<body class="gray-bg">
        ...
        <div class="row">
			 ...
			 <div class="col-lg-2">
				<div class="input-group">
					...
					<input readonly="readonly" placeholder="开始时间" id="txt_search_start" name="start" class="laydate-icon form-control layer-date"/>
                    <input readonly="readonly" placeholder="结束时间"id="txt_search_end" name="end" class="laydate-icon form-control layer-date"/>
				</div>
			 </div>
					...
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>性别：</td>
								<td><input type="radio" id="sSex" name="sSex" value="男"/>男
									<input type="radio" id="sSex" name="sSex" value="女"/>女
								</td>
							</tr>
							<tr>
								<td>爱好：</td>
								<td><input type="checkbox" id="sHobby1" name="sHobby" value="篮球"/>篮球
									<input type="checkbox" id="sHobby2" name="sHobby" value="足球"/>足球
									<input type="checkbox" id="sHobby3" name="sHobby" value="睡觉"/>睡觉
									</td>
								<td>&nbsp;&nbsp;</td>
								<td>生日：</td>
								<td>
									<input readonly="readonly" placeholder="请输入时间" id="sBirth" name="sBirth" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
							<tr>
								<td>专业：</td>
	...
	<!-- 导入对话框 -->
	<div class="modal fade" id="modal_import" role="dialog" aria-labelledby="modal_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_import" method="post" action="import.htm" enctype="multipart/form-data">
	...
	<!-- 统计对话框  饼状-->
	<div class="modal fade" id="modal_tongji" role="dialog" aria-labelledby="modal_tongji" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
	...
	<!-- 统计对话框  柱状-->
	<div class="modal fade" id="modal_tongji_zz" role="dialog" aria-labelledby="modal_tongji_zz" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<div id="main" style="width: 600px;height: 400px"></div>
	...
	<!-- 统计对话框  折线-->
	<div class="modal fade" id="modal_tongji_zx" role="dialog" aria-labelledby="modal_tongji_zx" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<div id="main" style="width: 600px;height: 400px"></div>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_export").click(function(){
				location.href="export.htm";
	        });
	    	
	    	$("#btn_import").click(function(){
    			$('#modal_import').modal({backdrop: 'static', keyboard: false});
    			$("#modal_import").show();
	        });
	        
	    	$("#btn_tongji").click(function(){
    			$('#modal_tongji').modal({backdrop: 'static', keyboard: false});
    			$("#modal_tongji").show();
	...
	function initEditUser(getSelection){
		...
		$('input[value='+getSelection.sSex+']').attr("checked",true);
		$('#sName').val(getSelection.sName);
		$('#sBirth').val(new Date(getSelection.sBirth).Format("yyyy-MM-dd"));
		$('#mId').val(getSelection.mId);
		$('#sHobby1').prop("checked",getSelection.sHobby.indexOf("足球")!=-1);
		$('#sHobby2').prop("checked",getSelection.sHobby.indexOf("篮球")!=-1);
		$('#sHobby3').prop("checked",getSelection.sHobby.indexOf("睡觉")!=-1);
	}
